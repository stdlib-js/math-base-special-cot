...
```javascript
import cot from 'https://cdn.jsdelivr.net/gh/stdlib-js/math-base-special-cot@v0.2.1-deno/mod.js';
```
...
[test-image]: https://github.com/stdlib-js/math-base-special-cot/actions/workflows/test.yml/badge.svg?branch=v0.2.1
[test-url]: https://github.com/stdlib-js/math-base-special-cot/actions/workflows/test.yml?query=branch:v0.2.1
